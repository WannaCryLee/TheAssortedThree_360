...
public class CerealTest {
	...
	private void setUpJobList() {
		...
		Job testJob = new Job("Rock", "Tuscany", "Tacoma, WA", "Clean Rocks", 3, 5, 3, 2015, 5, 15, 2015, 5, 15);
		
		test.put(test.size(), testJob);
		
		testJob = new Job("Bark", "Tuscany", "Tacoma, WA", "New Bark",3, 5, 3, 2015, 5, 30, 2015, 5, 30);
		
		test.put(test.size(), testJob);
		
		testJob = new Job("Sweep", "Wright", "Tacoma, WA", "Sweep Sidewalks", 3, 5, 3, 2015, 6, 15, 2015, 6, 15);
		
		test.put(test.size(), testJob);
		
		testJob = new Job("Garbage", "Wright", "Tacoma, WA", "Change all the Garbage", 3, 5, 3, 2015, 7, 15, 2015, 7, 15);
		
		test.put(test.size(), testJob);
		
		testJob = new Job("New Fountain", "Lighthouse", "Tacoma, WA", "Install new fountain", 3, 5, 3, 2015, 8, 15, 2015, 8, 15);
		
		test.put(test.size(), testJob);
		
		testJob = new Job("BBQ", "LightHouse", "Tacoma, WA", "Cook Meat :)", 3, 5, 3, 2015, 9, 15, 2015, 9, 15);
