...
public class Data {
	...
	public void freshData() {
		...
		Job startingJob = new Job("Rock", "Tuscany", "Tacoma, WA", "Clean Rocks", 3, 5, 3, false, 2015, 5, 15, 2015, 5, 15);
		
		startingMap.put(startingMap.size(), startingJob);
		
		startingJob = new Job("Bark", "Tuscany", "Tacoma, WA", "New Bark",3, 5, 3, false, 2015, 5, 30, 2015, 5, 30);
		
		startingMap.put(startingMap.size(), startingJob);
		
		startingJob = new Job("Sweep", "Wright", "Tacoma, WA", "Sweep Sidewalks", 3, 5, 3, false, 2015, 6, 15, 2015, 6, 15);
		
		startingMap.put(startingMap.size(), startingJob);
		
		startingJob = new Job("Garbage", "Wright", "Tacoma, WA", "Change all the Garbage", 3, 5, 3, false, 2015, 7, 15, 2015, 7, 15);
		
		startingMap.put(startingMap.size(), startingJob);
		
		startingJob = new Job("New Fountain", "Lighthouse", "Tacoma, WA", "Install new fountain", 3, 5, 3, false, 2015, 8, 15, 2015, 8, 15);
		
		startingMap.put(startingMap.size(), startingJob);
		
		startingJob = new Job("BBQ", "LightHouse", "Tacoma, WA", "Cook Meat :)", 3, 5, 3, false, 2015, 9, 15, 2015, 9, 15);
